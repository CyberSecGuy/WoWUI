...
VExRT = {
	...
	["ExCD2"] = {
		...
		["gnGUIDs"] = {
			["Salparadise-Sen'jin"] = 269,
			["Razerra-SistersofElune"] = 250,
			["Oldfool-Sargeras"] = 63,
			["Kithara-Mal'Ganis"] = 256,
			["Liara-KulTiras"] = 259,
			["Superrbeast-Proudmoore"] = 103,
			["Arelio-Tichondrius"] = 103,
			["Trayssa-MoonGuard"] = 259,
			["Dragonis-LaughingSkull"] = 64,
			["Mikami-Aman'Thul"] = 251,
			["Watercolour-Dragonblight"] = 105,
			["Cheelo-Kargath"] = 64,
			["Lilann"] = 64,
			["Voidbro"] = 72,
			["Kogudo-Quel'Thalas"] = 251,
			["Misshealy-DarkIron"] = 105,
			["Baeron-Garona"] = 263,
			["Lapeste-MoonGuard"] = 250,
			["Geemjoo-Zul'jin"] = 70,
