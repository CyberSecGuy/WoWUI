					...
					children = {
						{
							...
							settingInfo = { TSMCore.db.global.mailingOptions, "defaultMailTab" },
						...
						},
						{
							...
							settingInfo = { TSMCore.db.global.mailingOptions, "defaultPage" },
					...
					children = {
						{
							...
							settingInfo = { TSMCore.db.global.mailingOptions, "inboxMessages" },
						...
						},
						{
							...
							settingInfo = { TSMCore.db.global.mailingOptions, "displayMoneyCollected" },
						...
						},
						{
							...
							settingInfo = { TSMCore.db.global.mailingOptions, "deleteEmptyNPCMail" },
						...
						},
						{
							...
							settingInfo = { TSMCore.db.global.mailingOptions, "autoCheck" },
						...
						},
						{
							...
							settingInfo = { TSMCore.db.global.mailingOptions, "showReloadBtn" },
						...
						{
							type = "Slider",
							value = TSMCore.db.global.mailingOptions.keepMailSpace,
							...
							callback = function(self, _, value)
								TSMCore.db.global.mailingOptions.keepMailSpace = value
							end,
						...
						},
						{
							...
							settingInfo = { TSMCore.db.global.mailingOptions, "openMailSound" },
						...
						},
						{
							...
							relativeWidth = 0.49,
							callback = function() TSMAPI:DoPlaySound(TSMCore.db.global.mailingOptions.openMailSound) end,
						},
					},
				},
				{
					...
					children = {
						{
							...
							settingInfo = { TSMCore.db.global.mailingOptions, "sendMessages" },
							tooltip = L["If checked, information on mails sent by TSM_Mailing will be printed out to chat."],
						},
						{
							type = "CheckBox",
							label = L["Send Items Individually"],
							settingInfo = { TSMCore.db.global.mailingOptions, "sendItemsIndividually" },
							tooltip = L["Sends each unique item in a seperate mail."],
						},
						{
							type = "Slider",
							value = TSMCore.db.global.mailingOptions.sendDelay,
							label = L["Mail Send Delay"],
							min = 0.1,
							max = 2,
							step = 0.1,
							relativeWidth = 0.49,
							disabled = not TSMCore.db.global.mailingOptions.sendDelay,
							callback = function(self, _, value)
								if value < 0.1 then value = 0.1 end
								if value > 2 then value = 2 end
								self:SetValue(value)
								TSMCore.db.global.mailingOptions.sendDelay = value
							end,
						...
						{
							type = "Slider",
							value = TSMCore.db.global.mailingOptions.resendDelay,
							label = L["Restart Delay (minutes)"],
							min = 0.5,
							max = 10,
							step = 0.5,
							relativeWidth = 0.49,
							disabled = not TSMCore.db.global.mailingOptions.resendDelay,
							callback = function(self, _, value)
								if value < 0.5 then value = 0.5 end
								if value > 10 then value = 10 end
								self:SetValue(value)
								TSMCore.db.global.mailingOptions.resendDelay = value
							end,
						...
						},
						{
							...
							settingInfo = {TSMCore.db.global.mailingOptions, "deMaxQuality"},
