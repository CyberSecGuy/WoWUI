...
function private.GetTooltipSettingsFrame()
	return TSMAPI_FOUR.UI.NewElement("ScrollFrame", "tooltipSettings")
		...
		:AddChild(TSMAPI_FOUR.UI.NewElement("Frame", "splitContent")
			...
			:AddChild(TSMAPI_FOUR.UI.NewElement("Frame", "left")
				:SetLayout("VERTICAL")
				:AddChild(TSMAPI_FOUR.UI.NewElement("Text", "globalHeading")
					:SetStyle("height", 19)
					:SetStyle("margin.bottom", 10)
					:SetStyle("font", TSM.UI.Fonts.MontserratBold)
					:SetStyle("fontHeight", 16)
					:SetStyle("textColor", "#ffffff")
					:SetText(L["Global Data Tooltips"])
				)
				:AddChild(TSM.MainUI.Settings.Tooltip.CreateCheckbox(L["Display global min buyout avg"], TSM.db.global.tooltipOptions.moduleTooltips.AuctionDB, "globalMinBuyout"))
				:AddChild(TSM.MainUI.Settings.Tooltip.CreateCheckbox(L["Display global market value avg"], TSM.db.global.tooltipOptions.moduleTooltips.AuctionDB, "globalMarketValue"))
				:AddChild(TSM.MainUI.Settings.Tooltip.CreateCheckbox(L["Display global historical price"], TSM.db.global.tooltipOptions.moduleTooltips.AuctionDB, "globalHistorical"))
				:AddChild(TSM.MainUI.Settings.Tooltip.CreateCheckbox(L["Display global sale avg"], TSM.db.global.tooltipOptions.moduleTooltips.AuctionDB, "globalSale"))
			)
		)
