...
GRM_Patch.SettingsCheck = function ( numericV )
    ...
    if numericV < 1.34 then
        GRM.EventDatabaseIntegrityCheckAndRebuild();
    end
end
...
-- R1.34
-- Method:          GRM.EventDatabaseIntegrityCheckAndRebuild()
...
GRM.EventDatabaseIntegrityCheckAndRebuild = function()
    if GRM_GuildMemberHistory_Save[GRM_G.FID][2][2][22][1][1] ~= nil and type ( GRM_GuildMemberHistory_Save[GRM_G.FID][2][2][22][1][1] ) == "table" and #GRM_GuildMemberHistory_Save[GRM_G.FID][2][2][22][1][1] == 3 then
        print("GRM: Integrity Check: Database is good...")
        return
    else
        print("GRM: Integrity Check: Database needs update...")
