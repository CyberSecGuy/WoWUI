...
GRML.Russian = function()
    ...
    GRM_L["Class:"] = "Класс:"
    GRM_L["Reason:"] = "Причина:"
    GRM_L["It is CRITICAL the player's name and server are spelled correctly for accurate tracking and notifications."] = "ВАЖНО ввести верные имя и сервер для отслеживания и оповещения"
