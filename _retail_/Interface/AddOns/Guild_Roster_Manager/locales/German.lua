...
GRML.German = function()
   ...
   -- EVENTS WINDOW
    ...
    GRM_L["Class:"] = "Klasse:"
    GRM_L["Reason:"] = "Grund:"
    GRM_L["It is CRITICAL the player's name and server are spelled correctly for accurate tracking and notifications."] = "EXTREM WICHTIG: Name und Server müssen unbedingt korrekt geschrieben sein!"
...
-- TIME AND DATES
    ...
    -- R1.1500
    GRM_L["It's almost time to celebrate {name}'s Birthday! ( {custom1} )"] = "Es ist fast soweit, um den Geburtstag von {name} zu feiern! ({custom1})"          -- Custom1 is the actual date.  Like "1 Mar '18"
